...
function assistantDisplayName(){
  ...
  return window._botName||'Raphael';
}
...
function _worklogDetailsExpandedDefault(){
  if (typeof window._worklogDetailsExpandedByDefault === 'boolean') {
    return window._worklogDetailsExpandedByDefault;
  }
  return true;
}
...
function chatActivityMode(){
  if(typeof window==='undefined') return 'transparent_stream';
