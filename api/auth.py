...
PUBLIC_PATHS = frozenset({
    ...
    '/galaxy', '/api/galaxy/projection', '/api/galaxy/status', '/api/galaxy/tree', '/api/galaxy/read_file', '/api/subagents/angels', '/api/omniroute/status',
...
def check_auth(handler, parsed) -> bool:
    ...
    if (
        ...
        or parsed.path.startswith('/vendor/')
